...
\newcommand{\Hat}[1]{
    \begin{center}
        {\fontsize{11}{12}\selectfont\color{rougeliturgique}#1}
    \end{center}
    \vspace{-.3cm}
}
...
% Références :
\newcommand{\Ref}[1]{
    {\fontsize{11}{12}\selectfont\textit{\color{rougeliturgique}#1}}
}

% Chapeau avec référence :
\newcommand{\HatWithRef}[2]{
    {\fontsize{11}{12}\selectfont\color{rougeliturgique}#1}\hfill\Ref{#2}
}
