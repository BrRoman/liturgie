...
% Références :
\newcommand{\Ref}[1]{
    {\fontsize{12}{14}\selectfont\textit{\color{rougeliturgique}\oldstylenums{#1}}}
}
...
% Textes en rouge :
\newcommand\Red[1]{{\color{rougeliturgique}\oldstylenums{#1}}}
...
ou recommandation de l'âme à Dieu

Si le malade est plus mal, on recommande son âme à Dieu. À défaut d'un prêtre, une des personnes présentes récites ces prières à genous, près du lit du malade. Si le malade le peut, il répond lui-même à ces prières faites pour lui au nom de l'Église.
Le cierge bénit est allumé et tenu par un des assistants. On peut dire au malade que ce cierge rappelle celui qui lui fut remis au baptême ; il est le symbole de sa foi chrétienne et le gage de la vie éternelle.

\begin{paracol}{2}
Kýrie, eléison.\switchcolumn
Seigneur, ayez pitié de lui (d'elle).\switchcolumn*

Christe, eléison.\switchcolumn
Jésus, ayez pitié de lui.\switchcolumn*

Kýrie, eléison.\switchcolumn
Seigneur, ayez pitié de lui.\switchcolumn*

Sancta María, ora pro eo (ea).\switchcolumn
Sainte Márie, priez pour lui (elle).\switchcolumn*

Omnes sancti Angeli et Archángeli, oráte pro eo.\switchcolumn
Tous les saints Anges et Archanges,\switchcolumn*

Sancte Abel,\switchcolumn
Saint Abel,\switchcolumn*

Omnis chorus justórum,\switchcolumn
Toute l'assemblée des justes,\switchcolumn*

Sancte Abraham,\switchcolumn
Saint Abraham,\switchcolumn*

Sancte Joánnes Baptísta,\switchcolumn
Saint Jean-Baptiste,\switchcolumn*

Sancte Joseph,\switchcolumn
Saint Joseph,\switchcolumn*

Omnes sancti Patriárchæ et Prophétæ,\switchcolumn
Tous les saints Patriárches et Prophètes,\switchcolumn*

Sancte Petre,\switchcolumn
Saint Pierre,\switchcolumn*

Sancte Paule,\switchcolumn
Saint Paul,\switchcolumn*

Sancte Andréa,\switchcolumn
Saint André,\switchcolumn*

Sancte Joánnes,\switchcolumn
Saint Jean,\switchcolumn*

Omnes sancti Apóstoli et Evangelístæ,\switchcolumn
Tous les saints Apôtres et Évangélistes,\switchcolumn*

Omnes sancti Discípuli Dómini,\switchcolumn
Tous les saints Disciples du Seigneur,\switchcolumn*

Omnes sancti Innocéntes,\switchcolumn
Tous les saints Innocents,\switchcolumn*

Sancte Stéphane,\switchcolumn
Saint Étienne,\switchcolumn*

Sancte Laurénti,\switchcolumn
Saint Laurent,\switchcolumn*

Omnes sancti Mártyres,\switchcolumn
Tous les saints Martyrs,\switchcolumn*

Sancte Silvéster,\switchcolumn
Saint Sylvestre,\switchcolumn*

Sancte Gregóri,\switchcolumn
Saint Grégoire,\switchcolumn*

Sancte Augustíne,\switchcolumn
Saint Augustin,\switchcolumn*

Omnes sancti Pontífices et Confessóres,\switchcolumn
Tous les saints Pontifes et Confesseurs,\switchcolumn*

Sancte Francísce,\switchcolumn
Saint François,\switchcolumn*

Sancte Camílle,\switchcolumn
Saint Camille,\switchcolumn*

Sancte Joánnes de Deo,\switchcolumn
Saint Jean de Dieu,\switchcolumn*

Omnes sancti Mónachi et Eremítæ,\switchcolumn
Tous les saints Moines et Ermites,\switchcolumn*

Sancta María Magdaléna,\switchcolumn
Sainte Marie-Madeleine,\switchcolumn*

Sancta Lúcia,\switchcolumn
Sainte Lucie,\switchcolumn*

Omnes sanctæ Vírgines et Víduæ,\switchcolumn
Toutes les saintes Vierges et Veuves,\switchcolumn*

Omnes Sancti et Sanctæ Dei, intercédite pro eo.\switchcolumn
Tous les Saints et Saintes de Dieu, intercédez pour lui (elle).\switchcolumn*

Propítius esto, parce ei, Dómine.\switchcolumn
Soyez lui propice, pardonnez-lui, Seigneur;\switchcolumn*

Propítius esto, exáudi eum (eam), Dómine.\switchcolumn
Soyez-lui propice, exaucez-le (la), Seigneur.\switchcolumn*

Propítius esto, líbera eum (eam), Dómine.\switchcolumn
Soyez-lui propice, libérez-le (la), Seigneur.\switchcolumn*

Ab ira tua, líbera eum (eam), Dómine.\switchcolumn
De votre colère, libérez-le (la), Seigneur.\switchcolumn*

A perículo mortis,\switchcolumn
Du danger de mort,\switchcolumn*

A mala morte,\switchcolumn
De la malemort,\switchcolumn*

A pœnis inférni,\switchcolumn
Des peines de l'enfer,\switchcolumn*

Ab omni malo,\switchcolumn
De tout mal,\switchcolumn*

A potestáte diáboli,\switchcolumn
Du pouvoir du diable,\switchcolumn*

Per Nativitátem tuam,\switchcolumn
Par votre Nativité,\switchcolumn*

Per Crucem et Passiónem tuam,\switchcolumn
Par votre Croix et votre Passion,\switchcolumn*

Per Mortem et sepultúram tuam,\switchcolumn
Par votre Mort et votre ensevelissement,\switchcolumn*

Per gloriósam Resurrectiónem tuam,\switchcolumn
Par votre glorieuse Résurrection,\switchcolumn*

Per admirábilem Ascensiónem tuam,\switchcolumn
Par votre admirable Ascension,\switchcolumn*

Per grátiam Spíritus Sancti Parácliti,\switchcolumn
Par la grâce de l'Esprit Saint, le Paraclet,\switchcolumn*

In die judícii, líbera eum (eam), Dómine.\switchcolumn
Au jour du Jugement, libérez-le (la), Seigneur.\switchcolumn*

Peccatóres, te rogámus, audi nos.\switchcolumn
Pécheurs, nous vous en supplions, écoutez-nous.\switchcolumn*

Ut ei parcas, te rogámus, audi nos.\switchcolumn
Afin que vous lui pardonniez, nous vous en supplions, écoutez-nous.\switchcolumn*
